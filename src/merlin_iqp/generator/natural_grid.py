"""K=462 (21x22) spatial-bin grid sized to match ``QuantumLayer.simple``'s
natural output width exactly, so no MerLin ModGrouping modulo-fold ever
runs. Paired index-for-index with radius-sorted bin centers and Fock-state
"smoothness" rank; see ``naturally_ordered_generator.py``."""
