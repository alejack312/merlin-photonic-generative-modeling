...
- Artifact-producing implementation head is `c1617601df5f7f5da6ccba324e8c0b32aab46054`; later commits are documentation/validator-only, so the suffixed artifacts are qualified as generated-at-c161 rather than mislabeled as exact-final-head runs. The final reviewer target is the checkout’s `git rev-parse HEAD`; base remains `de80e9313beed614528fd6332b2f78aab83c0b50`.
