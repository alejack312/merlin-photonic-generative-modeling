...
| RING-03 | INCONCLUSIVE | D3 data-dependent parity initialization at scale `0.1` is implemented and n=4 smoke tests pass; n=6/8 five-seed, 300-step main cells have not been launched under the selected initialization. | Run the registered n=6/8 primary cells and record deterministic duplicate identities and `n_unique`. | None |
