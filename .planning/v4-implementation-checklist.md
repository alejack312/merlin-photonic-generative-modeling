...
| 32 — synthesis, review, communication | WRITE-07..09, REVIEW-02, COMM-02 | owner explanation transcript before interpretive prose; three workstream reports plus `docs/tcdp-study.md`; mirrors contain artifact-linked verified claims only; Fable/Opus and Codex review dispositions; owner journal and Vincent draft with send/hold record |
