...
As of this writing, the repo contains only [MerLin_SMART_Spec_Sept1.md](MerLin_SMART_Spec_Sept1.md) — the planning document. No code, environment, or scaffolding exists yet. There are no build/lint/test commands to document because there is nothing to build yet. Once the repo is scaffolded (Jul 18 milestone: MerLin installed, quickstart run locally), update this file with the actual commands (install, run, test) — don't leave this section stale.
