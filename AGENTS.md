...
The 2026-09-24 documentation continuation is indexed in [docs/v4-full-completion-audit.md](docs/v4-full-completion-audit.md), with executable work packages in [.planning/v4-full-completion-roadmap.md](.planning/v4-full-completion-roadmap.md). It tracks 51 active original requirements plus retired COMM-02 separately from new correlator/generalization benchmarks and proposed MBQC/adaptivity work. No new experimental result or MBQC implementation is established by that plan; owner conceptual checkpoints remain in force.
