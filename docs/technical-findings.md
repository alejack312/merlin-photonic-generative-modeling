...
`results/phase18_mixed_loss_sweep.csv` (Hardness-under-loss), and
`results/phase16_alpha_sweep.csv` / `tests/test_iqp_photonic_encoding.py`
(ARB-01/ARB-02). No new, uncited number was introduced anywhere in this
document. This document's TRAIN-09/TRAIN-10 negative-result language,
