...
- The authoritative ledger now marks NULL-03–06, the owner-authored NULL-07 hypothesis, the binding NULL-08 control, registered REPRO-03 small-n retraining, and the selected sibling/substrate comparison scope `PASS`; NULL-07’s experimental adjudication remains `INCONCLUSIVE`; WRITE-07 remains `BLOCKED`; and SWEEP-04, RING-04, COMPARE-01 and COMPARE-04 remain qualified because broader physical, uncertainty, and missing-input rows are still incomplete. The former COMM-02 communication gate was retired by the owner on 2026-09-08. v4.0 is therefore not fully scientifically accepted.
