...
results/phase22_allocation_invariant.md is itself a valid, minimum-count
...
results/phase22_allocation_invariant.md's "What the Forge model will
actually ask").
...
# check against results/phase22_allocation_invariant.md's
...
# ---------------------------------------------------------------------------
# Forge's minimum K per n, quoted from results/phase22_forge_run_log.md
    ...
    for n in range(2, args.n_max + 1):
        ...
        if forge_k is not None and forge_k != min_k:
            msg = (
                ...
                f"Forge min_K={forge_k} (results/phase22_forge_run_log.md)"
            )
            print(f"  {msg}")
            disagreements.append(msg)
        elif forge_k is not None:
            print(f"  matches Forge's min_K={forge_k} at n={n} (results/phase22_forge_run_log.md)")
