...
(TRAIN-07). Writes `results/v3_trainability/phase17_curve_fit_summary.csv` and two plots.

Data source: `results/v3_trainability/phase17_weight1_gradient_variance.csv` and
`results/v3_trainability/phase17_mixed_gradient_variance.csv` (Plan 17-06's CORE datasets,
complete and final). If the STRETCH background job launched during Plan
17-06 (n=7 weight-1, n=6 mixed) has produced
`results/v3_trainability/phase17_weight1_gradient_variance_stretch.csv` /
`results/v3_trainability/phase17_mixed_gradient_variance_stretch.csv` by the time this
...
from merlin_iqp.trainability.curve_fit import exp_model, fit_and_compare, poly_model

RESULTS_DIR = "results/v3_trainability"
