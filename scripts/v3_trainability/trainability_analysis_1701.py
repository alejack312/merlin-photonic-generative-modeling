...
(`results/v3_trainability/phase171_train09_{weight1,mixed}_gradient_variance.csv`), fit
...
that original verdict, loaded from `results/v3_trainability/phase17_curve_fit_summary.csv`
...
(`results/v3_trainability/phase171_train10_{weight1,mixed}_gradient_variance.csv`,
...
def load_phase17_baseline():
    """Load results/v3_trainability/phase17_curve_fit_summary.csv into
